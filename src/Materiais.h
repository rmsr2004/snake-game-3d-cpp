...
inline void loadMaterial(int material) {
	...
	GLfloat darkGreenPlasticAmb[] = { 0.0, 0.4, 0.0, 1.0 };
	GLfloat darkGreenPlasticDif[] = { 0.0, 0.5, 0.0, 1.0 };
	GLfloat darkGreenPlasticSpec[] = { 0.2, 0.5, 0.2, 1.0 };
	GLint darkGreenPlasticCoef = 0.15 * 128;
	...
	case 17: //�����������������������������������yellowPlastic
		...
		break;
	case 18:
		glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, darkGreenPlasticAmb);
		glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, darkGreenPlasticDif);
		glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, darkGreenPlasticSpec);
		glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, darkGreenPlasticCoef);
